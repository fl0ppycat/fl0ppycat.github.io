...
let testEl = document.querySelector('.testBtn');
let leftEl = document.querySelector('.leftBtn');
let rightEl = document.querySelector('.rightBtn');

pauseBall = () => {

}

testEl.addEventListener('click', pauseBall);
moveLeft = () => {
